...
class NXPEdgePass(ExportPass):
    """ Abstract parent class for pre-processing passes on the edge dialect level. Designed to be used with the
         `XNNPACKPassManager`.
    """
    ...
    def call(self, graph_module: torch.fx.GraphModule) -> PassResult:
        ...
        """
        iteration_limit = 50  # Empirical value.
        modified = False
    ...
    def recompile_module(self, graph_module: torch.fx.GraphModule) -> torch.fx.GraphModule:
